...
function PaginaCertificacion() {
  return (
    <>
      <HeaderAuxiliar />
      <main>
        <div className='conjunto-externo-certificacion'>
          <div className='sector-1-certificacion'>
            <div className='imagen-sector-1-certificacion'>
            <img src={materialesCertificacion} alt='materialesCertificacion' className='materialesCertificacion' />
            </div>
            <div className='texto-sector-1-certificacion'>
          ...
          <div className='sector-2-certificacion'>
            <div className='texto-sector-2-certificacion'>
            ...
            <div className='imagen-sector-2-certificacion'>
              <img src={procesoProduccion} alt='procesoProduccion' className='procesoProduccion' />
            </div>
          </div>
          <div className='sector-3-certificacion'>
            <div className='imagen-sector-3-certificacion'>
            <img src={controlDeCalidad} alt='controlDeCalidad' className='controlDeCalidad' />
            </div>
            <div className='texto-sector-3-certificacion'>              
